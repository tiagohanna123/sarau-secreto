  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-3">
        <div className="w-10 h-10 rounded-xl bg-gold-subtle border border-gold/8 flex items-center justify-center shrink-0 group-hover:bg-gold-glow group-hover:border-gold/15 transition-all duration-500">
          <Icon size={16} className="text-gold-dim group-hover:text-gold transition-colors" />
        </div>
        ...
        <motion.span
          ...
          className="text-sm font-medium text-gold shrink-0 tracking-wide"
        >
          {anuncio.valor}
        </motion.span>
      </div>
