  ...
  return (
    <div className="text-center mb-16 sm:mb-20">
      {label && (
        ...
        >
          <span className="text-[0.5rem] tracking-[0.3em] uppercase text-gold-dim font-medium inline-block relative">
            <span className="absolute -left-6 top-1/2 w-4 h-px bg-gold/30" />
            {label}
            <span className="absolute -right-6 top-1/2 w-4 h-px bg-gold/30" />
          </span>
        </motion.div>
      )}
      <motion.h2
